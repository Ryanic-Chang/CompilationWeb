<div align="center">
  ...
  <p><b>Compilation Web</b> 是一套风格明亮、现代化的编译原理实验网页版平台。<br/>旨在将传统的编译原理实验（如 DFA 模拟、词法分析、LR(0)、SLR(1) 语法分析、语义分析、AST 可视化与中间代码生成）通过纯前端方式直接搬到网页端，提升学习体验、交互性和对算法的理解。</p>
</div>
...
├── mainGGG.txt     # 实验五/实验六默认文法：前端语义与中间代码模块自动载入的主文法
